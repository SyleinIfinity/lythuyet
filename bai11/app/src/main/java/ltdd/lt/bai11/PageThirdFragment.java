...
import ltdd.lt.bai11.databinding.FragmentPageThirdBinding; // Đổi tên binding

public class PageThirdFragment extends Fragment implements HaiTacListener {

    private FragmentPageThirdBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentPageThirdBinding.inflate(inflater, container, false);
        ...
        // YÊU CẦU: Hiển thị theo Grid (ví dụ 2 cột)
