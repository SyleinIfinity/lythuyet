...
// SỬA 1: Đổi tên class
public class HaiTacGridAdapter extends RecyclerView.Adapter<HaiTacViewHolder> {
    ...
    // Đổi tên constructor
    public HaiTacGridAdapter(Context context, ArrayList<HaiTacModel> haiTacList, HaiTacListener listener) {
    ...
    public HaiTacViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // SỬA 2: Trỏ đến layout grid mới
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_hai_tac_grid, parent, false);
        return new HaiTacViewHolder(view);
    }

    // Hàm onBindViewHolder và getItemCount giữ nguyên y hệt
    @Override
